...
public partial class TkiemGiaodich
{
    ...
    public virtual ICollection<TkiemGiaingan> TkiemGiaingans { get; set; } = new List<TkiemGiaingan>();

    public virtual ICollection<TkiemLuukyhanTattoan> TkiemLuukyhanTattoans { get; set; } = new List<TkiemLuukyhanTattoan>();

    public virtual TkiemLuukyhanmoi? TkiemLuukyhanmoi { get; set; }
}
