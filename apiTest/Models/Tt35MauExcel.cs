...
public partial class Tt35MauExcel
{
    ...
    public string? TenSheet2 { get; set; }

    public string? FileMau { get; set; }

    public string? DlpsSheet1 { get; set; }

    public string? DlpsSheet2 { get; set; }
    ...
    public string? CellTenFile { get; set; }

    public string? CellMaQuy { get; set; }

    public string? CellDlps { get; set; }

    public string? CellNgayDlps { get; set; }

    public string? CellDonvitinh { get; set; }

    public string? Donvitinh { get; set; }

    public string? CellReadOnly { get; set; }

    public string? CellNameKdbc { get; set; }

    public string? CellIdkdbc { get; set; }
}
